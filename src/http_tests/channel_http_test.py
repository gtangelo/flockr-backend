...
def test_channel_invite_login_user_HTTP(url, user_1, user_2, user_3, user_4, public_channel_1):
...
def test_channel_invite_invalid_user_HTTP(url, user_1, public_channel_1):
...
def test_channel_invite_not_authorized_HTTP(url, user_1, user_2, user_3, public_channel_3):
    ...
    """
    logout_user_3 = requests.post(f'{url}auth/logout', json={
        'token': user_3['token']
    }).json()
    assert logout_user_3['is_success']
...
def test_channel_invite_invalid_self_invite_HTTP(url, user_1, public_channel_1):
...
def test_channel_multiple_invite_HTTP(url, user_1, user_2, public_channel_1):
...
def test_channel_invite_successful_HTTP(url, user_1, user_2, user_3, user_4, public_channel_1):
...
def test_channel_invite_flockr_user_HTTP(url, user_1, user_2, user_3, private_channel_2):
...
def test_channel_details_invalid_user_HTTP(url, user_1, user_2, public_channel_1):
...
def test_channel_details_invalid_token_HTTP(url, user_1, public_channel_1, logout_user_1):
...
def test_channel_details_authorized_user_HTTP(url, user_1, user_2, user_3, user_4, public_channel_1):
...
def test_output_details_twice_HTTP(url, user_1, user_2, public_channel_1):
    ...
    public_channel_1_2 = requests.post(f'{url}/channels/create', json=channel_profile).json()
    ...
    channel_profile = {
        'token'     : user_1['token'],
        'channel_id': public_channel_1_2['channel_id'],
    }
...
def test_input_messages_start(url, user_1, public_channel_1):
...
def test_input_messages_start_equal_10(url, user_1, public_channel_1):
    """Testing when start index is equal to the total number of messages, it will
    instead raise an InputError (assumption).
    """
    create_messages(url, user_1, public_channel_1['channel_id'], 0, 10)
    resp = requests.get(url + '/channel/messages', params={
        'token': user_1['token'],
        'channel_id': public_channel_1['channel_id'],
        'start': 10,
...
def test_access_messages_valid_token(url, user_1, public_channel_1, logout_user_1):
...
def test_output_no_messages(url, user_1, public_channel_1):
    """Testing when a channel has no messages
    """
    resp = requests.get(url + '/channel/messages', params={
        'token': user_1['token'],
...
def test_output_messages_1(url, user_1, public_channel_1):
    """Testing when a channel has a single message
    """
    message_list = create_messages(url, user_1, public_channel_1['channel_id'], 0, 1)
...
def test_output_messages_10_start_0(url, user_1, public_channel_1):
    """Testing when a channel has 10 messages at start 0.
    """
    message_list = create_messages(url, user_1, public_channel_1['channel_id'], 0, 10)
...
def test_output_messages_10_start_5(url, user_1, public_channel_1):
...
def test_output_messages_49_start_0(url, user_1, public_channel_1):
    """Testing when a channel has 49 total messages at start 0.
    """
    message_list = create_messages(url, user_1, public_channel_1['channel_id'], 0, 49)
...
def test_output_messages_49_start_25(url, user_1, public_channel_1):
...
def test_output_messages_50_start_0(url, user_1, public_channel_1):
    """Testing when a channel has 50 total messages at start 0.
    """
    message_list = create_messages(url, user_1, public_channel_1['channel_id'], 0, 50)
...
def test_output_messages_50_start_25(url, user_1, public_channel_1):
...
def test_output_messages_50_start_49(url, user_1, public_channel_1):
...
def test_output_messages_51_start_0(url, user_1, public_channel_1):
    """Testing when a channel has 51 total messages at start 0.
    """
    message_list = create_messages(url, user_1, public_channel_1['channel_id'], 0, 51)
...
def test_output_messages_51_start_25(url, user_1, public_channel_1):
...
def test_output_messages_51_start_50(url, user_1, public_channel_1):
...
def test_output_messages_100_start_10(url, user_1, public_channel_1):
    """Testing when a channel has 100 total messages at start 10.
    """
    message_list = create_messages(url, user_1, public_channel_1['channel_id'], 0, 100)
...
def test_output_messages_125_start_0(url, user_1, public_channel_1):
    """Testing when a channel has 125 total messages at start 0.
    """
    message_list = create_messages(url, user_1, public_channel_1['channel_id'], 0, 125)
...
def test_output_messages_125_start_50(url, user_1, public_channel_1):
...
def test_output_messages_125_start_100(url, user_1, public_channel_1):
...
def test_access_leave_valid_token(url, user_1, public_channel_1, logout_user_1):
    """Testing if token is valid
    """
    payload = requests.post(f'{url}/channel/leave', json={
        'token': user_1['token'],
...
def test_output_user_leave_public(url, user_1, public_channel_1):
...
def test_output_user_leave_private(url, user_1, private_channel_1):
...
def test_output_user_leave_channels(url, user_1, public_channel_1):
...
def test_output_member_leave(url, user_1, user_2, user_3, public_channel_1):
...
def test_output_all_members_leave(url, user_1, user_2, public_channel_1):
...
def test_output_flockr_rejoin_channel(url, user_1, user_2, public_channel_1):
    ...
    user_1_details = {'u_id': user_1['u_id'], 'name_first': 'John', 'name_last': 'Smith', 'profile_img_url': '',}
    assert user_1_details in payload['owner_members']
    assert user_1_details in payload['all_members']

    requests.delete(f'{url}/clear')

def test_output_creator_rejoin_channel(url, user_1, user_2, user_3, public_channel_1):
    ...
    user_2_details = {'u_id': user_2['u_id'], 'name_first': 'Jane', 'name_last': 'Smith', 'profile_img_url': '',}
...
def test_access_join_valid_token(url, user_1, public_channel_1, logout_user_1):
    """Testing if token is valid
    """
...
def test_access_join_user_is_member(url, user_1, user_2, user_3, private_channel_1, private_channel_2):
    ...
    """
    res_err = requests.post(url + 'channel/join', json={
        'token'     : user_3['token'],
        'channel_id': private_channel_2['channel_id'],
    })
    assert res_err.status_code == AccessError.code
...
def test_output_user_join_public(url, user_1, user_2, public_channel_1):
...
def test_output_user_join_flockr_private(url, user_1, user_2, private_channel_2):
...
def test_output_user_join_flockr_member_list(url, user_1, user_2, private_channel_2):
    """Test for flockr owner (flockr owner can join private channels)
    """
    # Assume that the first user is the flockr owner
    arg_join = {
...
def test_output_user_join_flockr_owner_list(url, user_1, user_2, private_channel_2):
    """Test for flockr owner (flockr owner can join private channels)
    """
    # Assume that the first user is the flockr owner
    arg_join = {
...
def test_access_add_valid_token(url, user_1, public_channel_1, logout_user_1):
    """Testing if token is valid
    """
    assert logout_user_1['is_success']
...
def test_add_user_is_already_owner(url, user_1, user_2, private_channel_1, private_channel_2):
...
def test_output_user_addowner_private(url, user_1, user_2, private_channel_1):
...
def test_output_user_addowner_public(url, user_1, user_2, public_channel_1):
...
def test_output_member_becomes_channel_owner(url, user_1, user_2, public_channel_1):
...
def test_access_remove_valid_token(url, user_1, public_channel_1, logout_user_1):
    """Testing if token is valid
    """
    assert logout_user_1['is_success']
...
def test_remove_user_is_not_owner(url, user_1, user_2, user_3, private_channel_1, private_channel_2):
...
def test_remove_user_is_owner(url, user_1, user_2, private_channel_1, private_channel_2):
    """Testing when the authorised user is not an owner of the flockr, or an owner of this channel
    """
    arg_removeowner = {
        'token'     : user_2['token'],
...
def test_output_user_removeowner_private(url, user_1, user_2, private_channel_1):
    ...
    for curr_owner in channel_data['owner_members']:
        assert curr_owner['u_id'] != user_2['u_id']
    requests.delete(url + '/clear')

def test_output_user_removeowner_public(url, user_1, user_2, public_channel_1):
